    ...
    <>
      <div className='space-y-6'>
        <TicketSummary
          ...
          isLoading={isLoading}
          errorMessage={
            isError ? 'Unable to load your ticket summary right now.' : undefined
          }
        ...
        <Card>
          <CardHeader className='flex items-center justify-between'>
            <div>
              ...
              <CardDescription>
                Track and manage the tickets available in your scope.
              </CardDescription>
            </div>
            {selectedCount > 0 ? (
          ...
          <CardContent>
            ...
            {isError ? (
              ...
              <TicketsTable
                ...
                detailsBasePath='/dashboard/agent/tickets'
              />
            )}
          </CardContent>
        </Card>
...
export default AgentTicketsContent;
