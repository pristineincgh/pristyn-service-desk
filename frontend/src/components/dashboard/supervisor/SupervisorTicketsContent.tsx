...
const SupervisorTicketsContent = () => {
    ...
    <>
      <div className='space-y-6'>
        <TicketSummary
          ...
          errorMessage={
            isError
              ? 'Unable to load the supervisor ticket summary right now.'
              : undefined
          }
        ...
        <Card>
          <CardHeader className='flex items-center justify-between'>
            <div>
              <CardTitle>Supervisor Ticket Workspace</CardTitle>
              <CardDescription>
                Manage tickets across your own queue and your assigned agents.
              </CardDescription>
            </div>
            {selectedCount > 0 ? (
          ...
          <CardContent>
            ...
            {isError ? (
              ...
              <TicketsTable
                ...
                detailsBasePath='/dashboard/supervisor/tickets'
              />
            )}
          </CardContent>
        </Card>
      ...
      <ReassignBulkTicketsModal
        ...
        ticketIds={selectedTicketIds}
        onReassigned={() => setSelectedTicketIds([])}
      />
      ...
      <UpdateBulkTicketStatusModal
        ...
        ticketIds={selectedTicketIds}
        onStatusesUpdated={() => setSelectedTicketIds([])}
      />
...
export default SupervisorTicketsContent;
